...
import NammokCard from "./NammokCard";
import oilbankMarker from "../img/oilbankMarker.png";

export default function Nammok() {
    ...
    script.onload = () => {
      ...
      if (window.kakao && window.kakao.maps) {
        ...
        window.kakao.maps.load(() => {
          const mapOption = {
            center: new window.kakao.maps.LatLng(35.536823, 129.417690),
            level: 4,
          };
          ...
          const content =
            ...
            '    <span class="title">남목주유소</span>' +
            "</div>";

          // 커스텀 오버레이가 표시될 위치 설정
          const customOverlayPosition = new window.kakao.maps.LatLng(35.536823, 129.41769);
