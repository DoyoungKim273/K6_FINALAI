...
import DongUlsanCard from "./DongUlsanCard";
import oilbankMarker from "../img/oilbankMarker.png";

export default function DongUlsan() {
    ...
    script.onload = () => {
      ...
      if (window.kakao && window.kakao.maps) {
        ...
        window.kakao.maps.load(() => {
          const mapOption = {
            center: new window.kakao.maps.LatLng(35.509008, 129.429959),
            level: 4,
          };
