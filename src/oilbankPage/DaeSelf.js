...
import DaeSelfCard from "./DaeSelfCard";

export default function DaeSelf() {
    ...
    script.onload = () => {
      ...
      if (window.kakao && window.kakao.maps) {
        ...
        window.kakao.maps.load(() => {
          const mapOption = {
            center: new window.kakao.maps.LatLng(35.507576, 129.417733),
            level: 3,
          };
          ...
          const content =
            ...
            '    <span class="title">현대오일뱅크직영 울산대교셀프주유소</span>' +
            "</div>";
