...
import HanSaeCard from "./HanSaeCard";
import oilbankMarker from "../img/oilbankMarker.png";

export default function HanSae() {
    ...
    script.onload = () => {
      ...
      if (window.kakao && window.kakao.maps) {
        ...
        window.kakao.maps.load(() => {
          const mapOption = {
            center: new window.kakao.maps.LatLng(35.488960, 129.413934),
            level: 2,
          };
          ...
          const content =
            ...
            '    <span class="title">한마음새마을금고주유소</span>' +
            "</div>";
